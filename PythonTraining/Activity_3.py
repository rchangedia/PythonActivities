...
if user1_answer != 'rock' or user1_answer != 'paper' or user1_answer != 'scissors':
 print(user1+", Invalid input! You have not entered rock, paper or scissors, try again.")
if user2_answer != 'rock' or user2_answer != 'paper' or user2_answer != 'scissors':
        print(user2+", Invalid input! You have not entered rock, paper or scissors, try again.")   
